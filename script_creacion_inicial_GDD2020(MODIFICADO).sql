...
-- VENTA_ESTADIA
INSERT INTO GDD2020.VENTA_ESTADIA(FACTURA_NRO, ESTADIA_CODIGO, VENTA_ESTADIA_CANTIDAD_NOCHES,
	VENTA_ESTADIA_FECHA_CHECK_IN, ESTADIA_PRECIO_VENTA)
SELECT DISTINCT FACTURA_NRO, ESTADIA_CODIGO, ESTADIA_CANTIDAD_NOCHES,
