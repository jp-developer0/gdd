...
CREATE TABLE [GDD2020].[COMPRA](
	...
	CONSTRAINT FK_ESTADIA_ID FOREIGN KEY (ESTADIA_CODIGO) REFERENCES [GDD2020].[COMPRA_ESTADIA](ESTADIA_CODIGO),
...
SELECT DISTINCT ma.PASAJE_CODIGO,ma.PASAJE_COSTO,ma.PASAJE_PRECIO,ma.PASAJE_FECHA_COMPRA,ma.VUELO_CODIGO
FROM gd_esquema.Maestra ma
...
INSERT INTO GDD2020.COMPRA_ESTADIA(ESTADIA_CODIGO, ESTADIA_FECHA_INICIO, 
	ESTADIA_CANTIDAD_NOCHES, ESTADIA_PRECIO_COSTO, hab.HABITACION_ID)
SELECT DISTINCT ma.ESTADIA_CODIGO, ma.ESTADIA_FECHA_INI, ma.ESTADIA_CANTIDAD_NOCHES,
	0.0, hab.HABITACION_ID
FROM gd_esquema.Maestra ma
JOIN GDD2020.HABITACION hab 
...
WHERE ESTADIA_CODIGO IS NOT NULL AND FACTURA_NRO IS NOT NULL
 --AND ESTADIA_CODIGO NOT IN (10004,10013,10014)
SET IDENTITY_INSERT GDD2020.COMPRA_ESTADIA OFF


--HASTA ACA
SET IDENTITY_INSERT GDD2020.COMPRA ON
INSERT INTO GDD2020.COMPRA(COMPRA_NUMERO, PASAJE_CODIGO, 
	COMPRA_FECHA, PROVEEDOR_CODIGO, ESTADIA_CODIGO, USUARIO_USERNAME)
SELECT DISTINCT COMPRA_NUMERO, PASAJE_CODIGO, COMPRA_FECHA, 
	p.PROVEEDOR_CODIGO, ESTADIA_CODIGO, 'usuarioNoDefinido'
FROM gd_esquema.Maestra ma
JOIN GDD2020.PROVEEDOR p ON ma.EMPRESA_RAZON_SOCIAL= p.EMPRESA_RAZON_SOCIAL
